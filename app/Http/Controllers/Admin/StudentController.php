...
class StudentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated['programStudi'] = auth()->user()->programStudi?->id ?? null;

        try {
            $this->studentService->create($validated);

            return redirect()->route('admin.student.index')->with('success', 'Berhasil menambahkan mahasiswa');
        } catch (\Throwable $th) {
    ...
    {
        return view('pages.admin.mahasiswa.edit', compact('student'));
    }
    ...
    public function update(Request $request, Student $student)
    {
        ...
        try {
            ...
            return redirect()->route('admin.student.index')->with('success', 'Berhasil mengubah mahasiswa');
        } catch (\Throwable $th) {
    ...
    public function destroy(Student $student)
    {
        ...
        $student->program_studi_id !== auth()->user()->program_studi_id
        ...
        try {
            ...
            return redirect()->route('admin.student.index')->with('success', 'Berhasil menghapus mahasiswa');
        } catch (\Throwable $th) {
