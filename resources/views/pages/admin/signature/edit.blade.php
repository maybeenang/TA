<x-app-layout>
    ...
    >
        ...
        <div class="mx-auto max-w-md" x-image-viewer>
            <h1 class="text-center text-xl font-semibold">Edit Tanda Tangan</h1>
            <x-form
                class=""
                method="POST"
                action="{{ route('admin.signature.update', $signature) }}"
            ...
            >
                ...
                <div class="h-28 w-28 bg-gray-200" x-ref="image-previewer-container">
                    <img x-ref="image-previewer" src="{{ route("admin.signature.show", $signature) }}" />
                </div>
