<x-app-layout>
    ...
    >
        <span class="flex items-center gap-1 text-sm">Buat Laporan Portofolio Perkuliahan</span>

        <section class="mx-auto max-w-screen-md rounded-md">
            <x-form class="mx-auto max-w-md" action="{{ route('super-admin.laporan.store') }}" method="POST">
                @csrf
