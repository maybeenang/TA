<x-app-layout>
    ...
    >
        ...
        <x-form class="mx-auto max-w-md" method="POST" action="{{ route('super-admin.kelas.store') }}">
            @csrf
            ...
            <x-form.item name="name">
                ...
                <x-form.description>
                    Untuk membuat lebih dari satu kelas, pisahkan nama kelas dengan tanda koma,
                    <span class="font-semibold">contoh: RA, RB, RC</span>
                </x-form.description>
                <x-form.message />
            </x-form.item>
